<template>
  <div :class="classes" :style="styles">
    ...
    <div :class="[prefixCls + '-textBox']">
      ...
      <countTo :class="[prefixCls + '-textBox-val']" :style="{color:numCor}" :startVal='startVal' :endVal="endVal"
               :decimals="getDecimals()" :suffix="getSuffix()" :duration='4000' v-else></countTo>
